...
import com.ssh.hui.dao.CourseCatalogDao;
import com.ssh.hui.dao.CourseDao;
import com.ssh.hui.dao.DepartmentDao;
import com.ssh.hui.dao.PlanOfStudyDao;
import com.ssh.hui.dao.ProfessorDao;
import com.ssh.hui.dao.ScheduleOfClassesDao;
...
public class BaseServiceImpl<T> implements BaseService<T>{
	...
	// 注入Dao
	//----------------
    @Resource(name="courseCatalogDao")
    protected CourseCatalogDao courseCatalogDao;
    @Resource(name="courseDao")
    protected CourseDao courseDao;
    @Resource(name="professorDao")
    protected ProfessorDao professorDao;
    
    @Resource(name="scheduleOfClassesDao")
    protected ScheduleOfClassesDao scheduleOfClassesDao;
    @Resource(name="sectionDao")
    protected SectionDao sectionDao;
    @Resource(name="studentDao")
    protected StudentDao studentDao;
    
    @Resource(name="transcriptDao")
    protected TranscriptDao transcriptDao;
    @Resource(name="transcriptEntryDao")
    protected TranscriptEntryDao transcriptEntryDao;
    @Resource(name="planOfStudyDao")
    protected PlanOfStudyDao planOfStudyDao;
