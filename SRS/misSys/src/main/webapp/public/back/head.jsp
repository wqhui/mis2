...
<!-- BEGIN HEADER -->
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
                    <a class="logo-default" href="${pageContext.request.contextPath}/base/back_index" style="color:#FFFFFF;font-size:18px;font-weight:bold;margin-top:10px"> 选课系统</a>
	...
	function loginOut(){
		$.ajax({
			url:'/misSys/base/professor_loginOut.action',
			method:'POST',
			dataType:'json',
			data:{
			},
